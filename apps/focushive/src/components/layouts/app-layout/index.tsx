...
const WeatherWidget = () => {
  ...
  return (
    <header className="space-y-2">
      <div className="flex justify-between justify-self-end items-start">
...
const AppLayoutContent = ({ children }: { children?: ReactNode }) => {
  return (
    <div className="relative flex-1 flex flex-col gap-4 max-h-screen w-full">
      <MyNavbar
        title="Good Afternoon, Alex!"
        extraContent={<WeatherWidget />}
      />
